...
*/
class Application_Model_CommentMapper extends Custom_Model_Mapper_Abstract
{
  protected $_dbTableClass = 'Application_Model_CommentDbTable';

  public function getBySubjectAjax(Application_Model_Comment $comment)
  {
    ...
    foreach ($rows->toArray() as $row)
    {
      ...
      $row['authUserId'] = $comment->getUser()->getId();
      $list[] = $row;
    }
