...
class Application_Model_HistoryType extends Custom_Model_Dictionary_Abstract
{
  ...
  const DELETE_TASK_FROM_DEFECT      = 20;
  const ADD_TASK_TO_DEFECT           = 21;
  const DELETE_TEST_FROM_DEFECT      = 22;
  const ADD_DEFECT_TO_TEST           = 23;
  const DELETE_DEFECT_FROM_TASK_TEST = 24;
  const DELETE_TASK_TEST_FROM_DEFECT = 25;
  const ADD_TASK_TEST_TO_TASK        = 26;
  const RESOLVE_TASK_TEST            = 27;
  const CHANGE_TASK_TEST_STATUS      = 28;
  const ADD_DEFECT_TO_TASK_TEST      = 29;
  const DELETE_DEFECT_FROM_TEST      = 30;
  const ADD_TASK_TEST_TO_DEFECT      = 31;
  const ADD_TEST_TO_DEFECT           = 32;
  ...
  protected $_names = array(
    ...
    self::DELETE_TASK_FROM_DEFECT        => 'DELETE_TASK_FROM_DEFECT',
    self::ADD_TASK_TO_DEFECT             => 'ADD_TASK_TO_DEFECT',
    self::DELETE_TEST_FROM_DEFECT        => 'DELETE_TEST_FROM_DEFECT',
    self::ADD_DEFECT_TO_TEST             => 'ADD_DEFECT_TO_TEST',
    self::DELETE_DEFECT_FROM_TASK_TEST   => 'DELETE_DEFECT_FROM_TASK_TEST',
    self::DELETE_TASK_TEST_FROM_DEFECT   => 'DELETE_TASK_TEST_FROM_DEFECT',
    self::ADD_TASK_TEST_TO_TASK          => 'ADD_TASK_TEST_TO_TASK',
    self::RESOLVE_TASK_TEST              => 'RESOLVE_TASK_TEST',
    self::CHANGE_TASK_TEST_STATUS        => 'CHANGE_TASK_TEST_STATUS',
    self::ADD_DEFECT_TO_TASK_TEST        => 'ADD_DEFECT_TO_TASK_TEST',
    self::DELETE_DEFECT_FROM_TEST        => 'DELETE_DEFECT_FROM_TEST',
    self::ADD_TASK_TEST_TO_DEFECT        => 'ADD_TASK_TEST_TO_DEFECT',
    self::ADD_TEST_TO_DEFECT             => 'ADD_TEST_TO_DEFECT'
  );
}