...
*/
class Report_Model_PhaseMapper extends Custom_Model_Mapper_Abstract
{
  protected $_dbTableClass = 'Report_Model_PhaseDbTable';
  ...
  public function getAll(Zend_Controller_Request_Abstract $request)
  {
    ...
    {
      $list[] = new Application_Model_Phase($row);
    }
