...
*/
class Report_EnvironmentController extends Custom_Controller_Action_Application_Project_Abstract
{
  ...
  {
    $environmentMapper = new Report_Model_EnvironmentMapper();
    list($list, $paginator) = $environmentMapper->getAll($this->getRequest());
  ...
  {
    $environmentMapper = new Report_Model_EnvironmentMapper();
    $rows = $environmentMapper->getAllForExport($this->getRequest());
