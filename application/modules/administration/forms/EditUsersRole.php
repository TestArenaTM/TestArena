...
*/
class Administration_Form_EditUsersRole extends Custom_Form_Abstract
{
  ...
  public function prepareJsonUserDataByRole(Application_Model_Role $role)
  {
    $result = array();
