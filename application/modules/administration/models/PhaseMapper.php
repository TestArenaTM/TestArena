...
*/
class Administration_Model_PhaseMapper extends Custom_Model_Mapper_Abstract
{
  protected $_dbTableClass = 'Administration_Model_PhaseDbTable';
  
  public function addDefault(Application_Model_Phase $phase)
  {
    $data = array(
