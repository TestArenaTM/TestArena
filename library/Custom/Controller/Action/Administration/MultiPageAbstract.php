...
*/
class Custom_Controller_Action_Administration_MultiPageAbstract extends Custom_Controller_Action_Administration_Abstract
{
  ...
  public function addFormBreadCrumbs($subForm)
  {
    ...
    { //mark enabled/valid subforms
      $breadCrumbs[] = array(
        'form'    => $v,
        'label'   => $t->translate('SUBFORM_LABEL_'.$formLabels[$v], null, 'administration/project-wizard/index'),
        'enabled' => true,
        'active'  => false,
  ...
  public function indexAction()
  {
    ...
    $form = $this->getForm()->prepareSubForm($form, $this->view->linkRoute()->getUrl('admin_project_wizard_add_process'), false, $this->checkAttachSubmitButton($form->getName()), $this->hasRemainingFormsLeft());
  ...
  public function processAction()
  {
    ...
    if (!$this->subFormIsValid($form, $postData))
    {
      ...
      $this->view->form = $this->getForm()->prepareSubForm($form, $this->view->linkRoute()->getUrl('admin_project_wizard_add_process'), $this->isLastSubForm($form->getName()), $this->checkAttachSubmitButton($form->getName()), $this->hasRemainingFormsLeft());
